...
val system = ActorSystem("GossipSystem")
 ...
 def main(args: Array[String])
 {
          ...
          val Master = system.actorOf(Props(new Master(numNodes,topology,algorithm,system,limit)), name = "Master")
...
class Master(numNodes:Int,topology:String,algorithm:String, system: ActorSystem, limit:Int) extends Actor
{
        var mastercount=0.0
